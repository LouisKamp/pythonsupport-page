...
.. card::
   ...
   script which unfortunately happens sometimes. Please try to use 
   :osref:`this guide <install-python-reference|automated-error-reference-windows|automated-error-reference-macos|install-python-linux>`
   instead.
