...
:course-base:`2023:02461` in the E23 year.
...
Ensure you have Python installed by following :ref:`this guide
<install-python>`. Note this will install Python using ``conda``.

We recommend you to create an :ref:`environment
<learn-more-environments>` for this course:
...
Every time you need to run code in the course, you need to activate the
environment:
...
The required packages should be installed in the above environment, and
